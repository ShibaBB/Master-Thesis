...
```text
run_full_symbolic_dataset_generation.m
run_full_symbolic_dataset_inspection.m
train_symbolic_segment_models.py
evaluate_symbolic_candidates.py
```

Current training runs are stored under:

```text
../artifacts/wool_symbolic_pysr_segments_runs
```

Current evaluation runs are stored under:

```text
../artifacts/wool_symbolic_candidate_evaluation_runs
```
