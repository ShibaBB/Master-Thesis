"""Train segment-wise PySR models for the scalar symbolic dataset.
...
def main() -> None:
    ...
    print(summary_df[["segment_name", "complexity", "test_rmse", "test_mae", "test_r2"]].to_string(index=False))
