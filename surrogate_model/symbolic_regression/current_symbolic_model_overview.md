...
```text
surrogate_model/symbolic_regression/run_full_symbolic_dataset_generation.m
```

Inspect the full symbolic dataset:

```text
surrogate_model/symbolic_regression/run_full_symbolic_dataset_inspection.m
```

Train segment-wise PySR models:

```text
surrogate_model/symbolic_regression/train_symbolic_segment_models.py
```

Evaluate candidate formulas and generate plots:

```text
surrogate_model/symbolic_regression/evaluate_symbolic_candidates.py
```

Early smoke-test drivers and environment checks have been archived here:

```text
surrogate_model/symbolic_regression/archive/smoke_tests
```
...
```text
surrogate_model/symbolic_regression/.venv_py311
```
...
```text
surrogate_model/symbolic_regression/artifacts/wool_symbolic_dataset_inspection/symbolic_dataset_inspection_report.txt
```
...
```text
surrogate_model/symbolic_regression/artifacts/wool_symbolic_pysr_segments_runs
```

The current real evaluation runs are stored under:

```text
surrogate_model/symbolic_regression/artifacts/wool_symbolic_candidate_evaluation_runs
```
...
```text
surrogate_model/symbolic_regression/artifacts/wool_symbolic_pysr_segments_runs/20260718_155023_iter100_pop12_ps100_size28_allrows_five_segments_iter100_pop12_ps100_size28
```
...
```text
surrogate_model/symbolic_regression/artifacts/wool_symbolic_candidate_evaluation_runs/20260718_160542_20260718_155023_iter100_pop12_ps100_size28_allrows_five_segments_iter100_pop12_ps100_size28_best_loss
```
...
```text
surrogate_model/symbolic_regression/artifacts/wool_symbolic_candidate_evaluation_runs/20260718_160548_20260718_155023_iter100_pop12_ps100_size28_allrows_five_segments_iter100_pop12_ps100_size28_max_complexity
```

Evaluation command:

```powershell
& 'surrogate_model\symbolic_regression\.venv_py311\Scripts\python.exe' `
  'surrogate_model\symbolic_regression\evaluate_symbolic_candidates.py' `
  --training-dir 'surrogate_model\symbolic_regression\artifacts\wool_symbolic_pysr_segments_runs\20260718_155023_iter100_pop12_ps100_size28_allrows_five_segments_iter100_pop12_ps100_size28' `
...
```text
surrogate_model/symbolic_regression/artifacts/wool_symbolic_candidate_evaluation_runs/20260718_160553_20260718_155023_iter100_pop12_ps100_size28_allrows_five_segments_iter100_pop12_ps100_size28_max_complexity
```
...
```powershell
& 'surrogate_model\symbolic_regression\.venv_py311\Scripts\python.exe' `
  'surrogate_model\symbolic_regression\train_symbolic_segment_models.py' `
  --niterations 40 `
  --populations 8 `
  --population-size 80 `
  --maxsize 24 `
...
& 'surrogate_model\symbolic_regression\.venv_py311\Scripts\python.exe' `
  'surrogate_model\symbolic_regression\evaluate_symbolic_candidates.py' `
  --training-dir 'surrogate_model\symbolic_regression\artifacts\wool_symbolic_pysr_segments_runs\<training_run_directory>'
```
